...
2. A significant test result means that the test hypothesis is false or should be rejected.
3. A large p value is evidence in favor of the test hypothesis.
4. If two confidence intervals overlap, the difference between two estimates or studies is not significant.
...
```{r}
knitr::include_graphics("asa_2016.png")
```

.footnote[Wasserstein RL, Lazar NA, Others. The ASA’s statement on p-values: context, process, and purpose. Am Stat. stat.berkeley.edu; 2016;70:129–33.]

---

Summary of recommendations (from 2019 paper):
